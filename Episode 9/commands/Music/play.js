...
const ytdl = require('ytdl-core') // npm i ytdl-core@4.0.5
const youtube = require('youtube-sr') // npm i youtube-sr@2.0.5
const ytpl = require('@distube/ytpl') // npm i @distube/ytpl@1.0.10
...
module.exports = {
    ...
    async function playSong(song, message, queue, ifPlaylist) {
